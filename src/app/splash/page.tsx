    ...
    >
      ...
      >
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
          ...
          <path d="M20 38 Q27 28 36 36 Q45 44 52 34" stroke="url(#logoGrad)" strokeWidth="3" strokeLinecap="round" fill="none" />
          <path d="M20 44 Q27 34 36 42 Q45 50 52 40" stroke="url(#waveGrad2)" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.55" />
      ...
      >
        ...
        <p className="text-sm font-medium" style={{ color: 'var(--text-muted)', letterSpacing: '0.12em' }}>
          KEUANGAN PRIBADIMU
        </p>
      </motion.div>
